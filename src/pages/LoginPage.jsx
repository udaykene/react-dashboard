...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen w-full flex">
      ...
      <div className="w-full lg:w-1/2 h-screen flex items-center justify-center px-6 sm:px-8 lg:px-16 py-12 bg-white">
      ...
      <div className="sm:hidden lg:flex lg:w-1/2 h-screen relative overflow-hidden">
        {/* Background Image */}
        <div 
          className="absolute inset-0 bg-cover bg-center"
          style={{
            backgroundImage: "url('https://images.unsplash.com/photo-1560066984-138dadb4c035?q=80&w=1740&auto=format&fit=crop')"
          }}
        ></div>
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-center px-12 w-full">
          ...
          <p className="text-white/90 text-lg lg:text-xl mb-8 max-w-md leading-relaxed">
            Book appointments, track your beauty history, and get exclusive member benefits all in one place.
          </p>
